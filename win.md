...
| SM120 D256 qpkv4/Hq16 S8192 noncausal backward auto-pack | auto-enable packed backward only for fixed dense bf16 D256 qpkv4 with 16 Q heads at S8192 noncausal | Targeted A/B `/tmp/sm120_bwd_d256_qpkv4_hq16_s8192_autopack_final_20260528`: auto vs forced pack-off +1.3% median (FA4/FA2 1.0935 vs 1.0795); explicit pack-on +2.4% vs forced pack-off. Hq8 and S4096 qpkv4 probes were noisy/mixed, so they stay pack-off. Correctness: explicit qpkv4 packed D256 backward added to the SM120 local SDPA test. | keeper, narrow |
