...
| Qwen D128 qpkv4 short/mid | post-`56310a8` lookup patch: S1024 noncausal/causal `64x64`; S8192 noncausal `128x32`; S8192 causal `128x64` | Subprocess public-API validation `/tmp/sm120_qpkv4_lookup_patch_narrow_validation_20260528`: 12 affected qwen3-embedding/qwen3-vl rows, geomean 1.081840 vs FA2, wins 12/12. FA4 time geomean vs saved post-qpkv artifact: 1.057589; correctness max_abs <= 0.00390625 on changed S1024/S8192 paths. | keeper; S4096 was explicitly reverted to prior lookup |
