...
| Current D256 backward smoke after nonpacked split2 | this commit, `/tmp/sm120_bwd_nonpack_split_default_validate_20260529`, `/tmp/sm120_bwd_d256_smoke_after_nonpack_split_20260529` | Exact nonpacked bf16 D256 qpkv6/qpkv8 S1024 causal now uses 2 M-splits. Default-vs-split1 validation: split1 won only 7/32 qpkv6, 4/32 qpkv8 H8, 5/32 qpkv8 H16; default medians were faster on all three. 3-repeat 8-row S1024 causal smoke vs FA2: geomean 1.009483, median 1.008901, wins 15/24; qwen geomean 1.016404, gemma 0.998054. | current D256 short-causal reference; qpkv8/qpkv6 mainloop CTA gap mostly addressed |
...
| SM120 D256 qpkv4 S1024 causal backward auto-pack8 | auto-enable packed backward only for fixed dense bf16 D256 qpkv4 S1024 causal, with 8 packed-M splits | Forced oversplit A/B `/tmp/sm120_bwd_packgqa_causal_oversplit_qpkv4_20260529`: pack8 vs forced pack-off mean speedups qwen3.5-0.8B +12.3%, qwen3.5-9B +5.7%, gemma4-e4b +9.7%. Final default-auto validation `/tmp/sm120_bwd_qpkv4_s1024_causal_auto_pack8_validate_20260529`: auto vs forced pack-off mean speedups +12.1%, +7.1%, +10.7%, with 6/6, 6/6, and 5/6 paired wins. Correctness: S1024 auto path checked vs SDPA for Hq8/Hkv2 and Hq16/Hkv4; split policy has a unit test. | keeper, S1024 causal qpkv4 only |
...
| SM120 D256 qpkv6/qpkv8 S1024 causal nonpacked M-split=4 | Rejected as the default. `/tmp/sm120_bwd_nonpack_split_32x_20260529`: split4 had similar medians to split2 on some qpkv8 rows but more large outliers and worse mean stability; qpkv6 split4 won fewer paired rounds than split2. Ship exact split2 only. |
